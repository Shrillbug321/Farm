...
namespace Farm.Areas.Identity.Pages.Account
{
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Potwierdź konto",
                        $"<a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Potwierdź założenie konta</a>.");

                    Profile profile = new Profile { Email = Input.Email, UserName = Input.Email };
